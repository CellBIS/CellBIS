...
CellBIS::enkripsi::jwt - Simple implementation JSON Web Token for CellBIS Web Toolkit on Crypt::JWT.
...
You can use L<Crypt::JWT> module and can use too in CellBIS Web Toolkit.
