...
CellBIS::Utils::Char - Utilities CellBIS Web Framework to split string.
...
=head SYNOPSIS
    ...
    # Splite based length :
    my @split_len = CellBIS::Utils::Char->blen($string, 1);
     
    # Splite based char :
    my @split_char = CellBIS::Utils::Char->bchar($string, " ");
